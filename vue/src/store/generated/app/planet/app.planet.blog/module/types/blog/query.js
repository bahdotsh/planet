...
export class QueryClientImpl {
    ...
    TimedoutPost(request) {
        ...
        const promise = this.rpc.request("app.planet.blog.Query", "TimedoutPost", data);
    ...
    TimedoutPostAll(request) {
        ...
        const promise = this.rpc.request("app.planet.blog.Query", "TimedoutPostAll", data);
    ...
    SentPost(request) {
        ...
        const promise = this.rpc.request("app.planet.blog.Query", "SentPost", data);
    ...
    SentPostAll(request) {
        ...
        const promise = this.rpc.request("app.planet.blog.Query", "SentPostAll", data);
    ...
    Post(request) {
        ...
        const promise = this.rpc.request("app.planet.blog.Query", "Post", data);
        return promise.then((data) => QueryGetPostResponse.decode(new Reader(data)));
    }
    PostAll(request) {
        const data = QueryAllPostRequest.encode(request).finish();
        const promise = this.rpc.request("app.planet.blog.Query", "PostAll", data);
