...
func NewMsgCreatePost(creator string, title string, content string) *MsgCreatePost {
...
func NewMsgUpdatePost(creator string, id uint64, title string, content string) *MsgUpdatePost {
